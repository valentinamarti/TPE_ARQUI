...
#define SNAKE_MENU ((color_t){175, 173, 196}) 
#define SNAKE_MENU_LETTERS ((color_t){168, 95, 245})
#define SNAKE_MENU_SELEC ((color_t){245, 245, 171})
#define SNAKE_GO_BACK ((color_t){74, 76, 148})
#define SNAKE_GO_TITLE ((color_t){232, 44, 44})
#define SNAKE_GO_POINTS ((color_t){215, 237, 175})
#define SNAKE_GO_ESC ((color_t){205, 201, 245})
